...
uint32_t saw_LUT[NS] = {0, 8, 16, 25, 33, 41, 49, 58, 66, 74, 82, 91, 99, 107, 115, 124, 132, 140, 148, 157, 165, 173, 181, 190, 198, 206, 214, 223, 231, 239, 247, 256, 264, 272, 280, 289, 297, 305, 313, 322, 330, 338, 346, 355, 363, 371, 379, 388, 396, 404, 412, 421, 429, 437, 445, 454, 462, 470, 478, 487, 495, 503, 511, 520, 528, 536, 544, 553, 561, 569, 577, 586, 594, 602, 610, 619, 627, 635, 643, 652, 660, 668, 676, 685, 693, 701, 709, 718, 726, 734, 742, 751, 759, 767, 775, 784, 792, 800, 808, 817, 825, 833, 841, 850, 858, 866, 874, 883, 891, 899, 907, 916, 924, 932, 940, 949, 957, 965, 973, 982, 990, 998, 1006, 1015, 1023
};
...
void EXTI0_1_IRQHandler(void)
{
	...
	curr_millis = HAL_GetTick();
		...
		if(curr_millis - prev_millis > 500)
		{
			...
			lcd_command(CLEAR);
			//Switch statement used to determine which wave to present.
			switch (wave_form)
			{
				case 0:
					wave_form = 1;
					lcd_putstring("Saw_Tooth");
